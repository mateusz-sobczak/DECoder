...
class TestDecoder(TestCase):
    ...
    def test_rsa(self):
        import rsa
        privateKey = rsa.PrivateKey(68706731939835159529538476419799965655742346573230197443885147162104769051533, 65537, 19061382122008680143523026355567129629292323946827194069036011864529823625833, 57075922549895275552549577057264864809031, 1203777860616660755154882879116047243)
